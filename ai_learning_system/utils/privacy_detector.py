...
class PrivacyDetector:
    ...
    def detect(self, content: str) -> dict:
        ...
        Returns:
            检测结果字典，包含 risk_level, sensitive_types 等
        """
        ...
        if detections.get('bank_cards', {}).get('count', 0) > 0:
            sensitive_types.append('bank_card')
        if detections.get('phones', {}).get('count', 0) > 0:
            sensitive_types.append('phone')
        if detections.get('id_cards', {}).get('count', 0) > 0:
            sensitive_types.append('id_card')
        if detections.get('passwords', {}).get('count', 0) > 0:
        ...
        return {
            ...
            'can_store': analysis.get('can_store', True)
        }
