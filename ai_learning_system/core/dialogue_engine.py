...
class DialogueEngine:
    ...
    def retrieve_context(self, message: str) -> Dict[str, Any]:
        """
        检索相关上下文信息
        ...
        if self.memory_manager:
            try:
                context["recent_history"] = self.memory_manager.get_recent_dialogue(limit=5)
                context["relevant_memories"] = self.memory_manager.search_related_memory(message)
