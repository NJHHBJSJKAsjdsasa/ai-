...
ITEMS_DB: Dict[str, Item] = {
    ...
    "材料包": Item(
        name="材料包",
        description="从战斗中获得的材料包，内含各种杂项材料。",
        item_type=ItemType.MATERIAL,
        rarity=ItemRarity.COMMON,
        effects=["出售换钱", "炼器辅助材料"],
        value=50,
    ...
    "灵石袋": Item(
        name="灵石袋",
        description="装有少量灵石的袋子，可从死斗对手身上获得。",
    ...
    "丹药": Item(
        name="丹药",
        description="从战斗中获得的普通丹药，可恢复少量生命值。",
        item_type=ItemType.PILL,
        rarity=ItemRarity.COMMON,
        effects=["恢复生命值"],
        value=30,
    ...
    "功法残页": Item(
        name="功法残页",
        description="破损的功法残页，收集完整后可学习新功法。",
    ...
    "妖兽皮毛": Item(
        name="妖兽皮毛",
        description="从妖兽身上剥取的皮毛，可用于制作护甲或出售。",
        item_type=ItemType.MATERIAL,
        rarity=ItemRarity.COMMON,
        effects=["炼器材料", "出售换钱"],
        value=20,
    ...
    "妖兽骨": Item(
        name="妖兽骨",
        description="妖兽的骨骼，质地坚硬，是炼制骨器的好材料。",
        item_type=ItemType.MATERIAL,
        rarity=ItemRarity.COMMON,
        effects=["炼器材料", "炼制骨器"],
        value=30,
    ...
    "妖兽内丹": Item(
        name="妖兽内丹",
        description="妖兽体内凝结的内丹，蕴含妖兽毕生修为。可用于炼丹或提升修为。",
        item_type=ItemType.MATERIAL,
        rarity=ItemRarity.RARE,
        effects=["炼丹材料", "提升修为", "炼制法宝"],
        value=500,
        stackable=True,
        max_stack=20,
        usable=True,
    ...
    "妖兽精血": Item(
        name="妖兽精血",
        description="妖兽的精血，蕴含强大的生命力和妖力。可用于炼制血丹或强化肉身。",
        item_type=ItemType.MATERIAL,
        rarity=ItemRarity.UNCOMMON,
        effects=["炼制血丹", "强化肉身", "炼丹材料"],
        value=150,
        stackable=True,
        max_stack=30,
        usable=False,
    ...
    "高级妖丹": Item(
        name="高级妖丹",
        description="高阶妖兽凝结的内丹，蕴含庞大的妖力。极为珍贵。",
        item_type=ItemType.MATERIAL,
        rarity=ItemRarity.EPIC,
        effects=["大幅提升修为", "炼制高阶丹药", "炼制法宝核心"],
        value=2000,
        stackable=True,
        max_stack=10,
        usable=True,
    ...
    "妖兽灵核": Item(
        name="妖兽灵核",
        description="妖兽体内最珍贵的核心，蕴含精纯的灵气。是炼制顶级法宝的必备材料。",
        item_type=ItemType.MATERIAL,
        rarity=ItemRarity.LEGENDARY,
        effects=["炼制顶级法宝", "大幅提升修为", "突破辅助"],
        value=10000,
        stackable=True,
        max_stack=5,
        usable=True,
